...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 181.5, 428.5, 311.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 371.0, 388.5, 363.0, 25.0 ],
					"text" : "This color slider is assigned to track the aX Optron sensor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -228.0, 470.5, 311.0, 55.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 31.5, 432.5, 133.0, 69.0 ],
					"text" : "Tilting will cause this waveform to go lower and higher"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 325.5, 311.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 452.0, 327.5, 290.0, 25.0 ],
					"text" : "Tilting the Optron changes the blaster color"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -38.0, 218.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 222.0, 175.0, 20.0 ],
					"text" : "Try short and long presses"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -29.0, 214.0, 150.0, 33.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 200.0, 175.0, 20.0 ],
					"text" : "Try gentle and hard presses"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -6.5, 187.0, 311.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 233.0, 168.5, 290.0, 25.0 ],
					"text" : "Pressing the Pressure Button fires the laser"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.5, 132.5, 311.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.5, 89.0, 172.0, 25.0 ],
					"text" : "Click to Toggle Audio On"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 20.0, 14.0, 214.0, 47.0 ],
					"text" : "Mini Blaster"
				}
...
,
					"patching_rect" : [ -36.0, 1243.0, 160.0, 115.0 ],
					"varname" : "patch_7",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ -40.0, 1092.0, 150.0, 126.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 320.0, 150.0, 126.0 ],
					"varname" : "patch_6",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 144.599999999999966, 1387.0, 29.5, 22.0 ],
					"text" : "+ 5"
				}
...
,
					"patching_rect" : [ 57.399999999999977, 1448.0, 237.0, 190.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 187.399999999999977, 320.0, 237.0, 190.0 ],
					"varname" : "patch_5",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 291.0, 1243.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 206.400000000000006, 1230.0, 40.0, 22.0 ],
					"text" : "* 100."
				}
...
,
					"patching_rect" : [ 119.199999999999989, 1092.0, 175.0, 130.0 ],
					"varname" : "patch_6[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 119.199999999999989, 1230.0, 40.0, 22.0 ],
					"text" : "* 255."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 152.0, 1046.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 348.0, 885.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 314.0, 885.0, 22.0, 140.0 ]
				}
...
,
					"patching_rect" : [ 214.0, 702.0, 175.0, 130.0 ],
					"varname" : "patch_6[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 425.0, 948.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 380.0, 446.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 555.0, 280.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 380.0, 417.0, 59.0, 22.0 ],
					"text" : "random 7"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 380.0, 485.0, 150.0, 210.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
,
					"patching_rect" : [ 486.0, 1972.0, 269.0, 190.0 ],
					"varname" : "patch_4",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 325.0, 1901.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 320.0, 1839.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 385.0, 1874.0, 33.0, 22.0 ],
					"text" : "!- 45"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 474.0, 1409.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 440.0, 1409.0, 22.0, 140.0 ]
				}
...
,
					"patching_rect" : [ 340.0, 1226.0, 175.0, 130.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 331.0, 342.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
,
					"patching_rect" : [ 331.0, 186.5, 105.0, 145.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 648.0, 1813.0, 40.0, 22.0 ],
					"text" : "* 500."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 542.0, 1862.0, 29.5, 22.0 ],
					"text" : "+ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 470.0, 1867.0, 29.5, 22.0 ],
					"text" : "- 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 612.5, 1901.0, 130.0, 47.0 ],
					"text" : "<< subtract half width from position to find center"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 612.5, 1862.0, 67.0, 20.0 ],
					"text" : "<< width"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 577.0, 1901.0, 29.5, 22.0 ],
					"text" : "/ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 577.0, 1811.0, 61.0, 22.0 ],
					"text" : "change 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 577.0, 1862.0, 33.0, 22.0 ],
					"text" : "* 12."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 577.0, 1776.0, 94.0, 22.0 ],
					"text" : "expr ($f1+$f2)/2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 474.0, 1818.0, 33.0, 22.0 ],
					"text" : "* 45."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 474.0, 1785.0, 61.0, 22.0 ],
					"text" : "change 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 474.0, 1747.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 602.0, 1582.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 449.0, 1582.0, 80.0, 13.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 139.0, 27.0, 126.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 474.0, 1708.0, 49.0, 22.0 ],
					"text" : "findPan"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 555.0, 1600.0, 45.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 27.0, 79.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 556.0, 166.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 555.0, 248.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 555.0, 215.0, 72.0, 22.0 ],
					"text" : "drunk 42 16"
				}
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 555.0, 316.0, 150.0, 1290.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
,
					"patching_rect" : [ 100.0, 301.0, 160.0, 115.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 139.0, 150.0, 126.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 143.5, 135.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 79.5, 91.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -27.5, 189.5, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 212.0, 171.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 431.0, 330.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
