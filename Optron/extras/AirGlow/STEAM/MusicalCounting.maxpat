...
,
					"patching_rect" : [ 346.0, 1117.0, 263.0, 191.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 477.0, 1068.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 400.0, 1055.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.0, 1061.0, 77.0, 22.0 ],
					"text" : "loadmess 10"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 220.0, 1025.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 215.5, 968.0, 29.5, 22.0 ],
					"text" : "* 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 226.0, 928.0, 29.5, 22.0 ],
					"text" : "/ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 226.0, 895.0, 69.0, 22.0 ],
					"text" : "r numLEDs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 695.0, 226.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 487.0, 150.0, 47.0 ],
					"presentation_linecount" : 3,
					"text" : "One of the most typical rhythms in western music is subdividing the total "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 648.5, 953.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.0, 670.0, 153.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 590.0, 150.0, 47.0 ],
					"text" : "One of the most typical rhythms in western music is subdividing the total "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 174.0, 824.5, 262.0, 37.0 ],
					"presentation_linecount" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 141.0, 748.0, 226.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 89.0, 748.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 72.0, 832.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 44.0, 796.0, 40.0, 22.0 ],
					"text" : "t 1 i i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.5, 129.0, 407.0, 33.0 ],
					"text" : "Click to tuen on Audio\nIf Audio was already on, Please click it off and back on again to reinitialize"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 123.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 425.0, 286.5, 301.0, 181.0 ],
					"text" : "The link.clocksource object lets you choose between 2 clock sources:\nLink Clock - used to sync to Ableton Live or can be used on its own.\nMax Clock - Choose this if you're just using the MAx application, or wish to sync with Logic.\nNet: Check this box if you want to enable ensemble control of bpm over a network\nManual Sync: Click this button to manually set the start time of your rhythmic pattern\nbpm: Click-hold-drag this number with the mouse up and down to set tempo. Alternatively click and type in a number and press return will set it as well."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 77.0, 449.0, 33.0 ],
					"text" : "This tutorial walks you though the link.clocksource and link.beats objects to learn about musical counting. You will learn about \"subdivisions\" "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 10.0, 406.0, 33.0 ],
					"text" : "STEAM Tutorial: Musical Counting"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 670.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.0, 762.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 984.5, 766.0, 79.0, 22.0 ],
					"text" : "link.beats 1 6"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 853.5, 883.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "2triangle-mute.aif",
								"filename" : "2triangle-mute.aif",
								"filekind" : "audiofile",
								"id" : "u938006453",
								"loop" : 0,
								"content_state" : 								{
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 637.5, 883.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "6triangle-mute.aif",
								"filename" : "6triangle-mute.aif",
								"filekind" : "audiofile",
								"id" : "u083006342",
								"loop" : 0,
								"content_state" : 								{
...
,
					...
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 44.0, 870.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 794.0, 746.0, 18.0, 50.0 ],
					"size" : 3,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 846.25, 770.0, 52.0, 22.0 ],
					"text" : "switch 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 853.5, 844.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 853.5, 812.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 578.0, 746.0, 18.0, 98.0 ],
					"size" : 6,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 15.0, 272.0, 406.0, 210.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1008.0, 735.0, 150.0, 20.0 ],
					"text" : "Tripplets"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 630.25, 770.0, 71.5, 22.0 ],
					"text" : "switch 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 875.5, 689.0, 86.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 776.0, 689.0, 79.0, 22.0 ],
					"text" : "link.beats 1 8"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 673.0, 689.0, 79.0, 22.0 ],
					"text" : "link.beats 1 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 578.0, 689.0, 79.0, 22.0 ],
					"text" : "link.beats 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 487.0, 689.0, 81.0, 22.0 ],
					"text" : "link.beats 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 637.5, 844.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 637.5, 812.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 924.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1076.5, 796.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 1076.5, 766.0, 86.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "bang", "bang" ],
					"patching_rect" : [ 89.0, 704.0, 79.0, 22.0 ],
					"text" : "link.beats 1 4"
				}
...
, 							{
								"box" : 								{
									...
									"text" : "1 0 1 63 22 1 63 11 4 63 122"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "ARGB 1 0 1 63 22 1 63 11 4 63 122"
								}
...
,
					"patching_rect" : [ 57.0, 1117.0, 269.0, 190.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 757.0, 260.0, 195.0, 130.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3.0, 135.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "0",
