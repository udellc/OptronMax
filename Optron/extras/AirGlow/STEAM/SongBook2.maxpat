...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 9.0, 2196.875, 811.5, 704.125 ],
					"pic" : "SomewhereOverTheRainbow.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.5, 2189.0, 831.0, 724.75 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 2077.75, 262.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 2106.75, 449.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 2075.0, 464.5, 102.75 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 1962.75, 262.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 1991.75, 449.0, 69.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 1960.0, 464.5, 105.75 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 1900.0, 464.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 578.0, 2044.0, 33.0, 22.0 ],
					"text" : "== 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 531.0, 1908.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 530.0, 1857.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3.0, 1928.0, 145.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 1857.0, 464.5, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 1775.75, 262.0, 27.0 ],
					"text" : "Change Key and Scale"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 1804.75, 449.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 1773.0, 464.5, 75.75 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "This song book assumes you have practiced Book 1, Introduction to scale, stepwise, and skip motion. Book 2 explores tilting the X axis to jump octaves to play melodies of a wider range."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 980.0, 445.0, 69.0 ],
					"text" : "Folow the dots below. When you see an arrow pointing down, angle the left hand side of the AirGlow toward the ground to play lower. Arrows pointing up indicate to angle the AirGlow toward the sky to play higher."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 943.25, 464.0, 111.75 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 9.0, 1082.0, 806.5, 675.607365792759083 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.5, 1073.0, 821.0, 688.75 ],
					"presentation" : 1,
...
, 			{
				"name" : "SomewhereOverTheRainbow.png",
				"bootpath" : "~/Documents/Max 8/Packages/Optron/media/scores",
				"patcherrelativepath" : "../../../media/scores",
				"type" : "PNG",
				"implicit" : 1
