...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1039.5, 367.0, 159.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 590.5, 777.0, 171.5, 24.0 ],
					"text" : "Pitch, Velocity"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 522.0, 887.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 522.0, 777.0, 54.0, 22.0 ],
					"text" : "pack 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 522.0, 810.567627000000016, 108.0, 23.0 ],
					"text" : "midiformat"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 522.0, 846.0, 131.0, 22.0 ],
					"save" : [ "#N", "vst~", "loaduniqueid", 0, "chipsounds.auinfo", ";" ],
...
,
									"fileref" : 									{
										"name" : "chipsounds",
										"filename" : "chipsounds_20200911.maxsnap",
										"filepath" : "~/Documents/Max 8/Snapshots",
										"filepos" : -1,
										"snapshotfileid" : "6eb073df47034292900fe396d300325a"
									}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 979.5, 265.0, 288.0, 24.0 ],
					"text" : "Fret number can be easily used for chord degree"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 794.5, 188.0, 159.0, 24.0 ],
					"text" : "Click Help Button for info"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 711.0, 81.0, 288.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 394.0, 80.5, 20.0 ],
					"text" : "Choose one:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 534.0, 469.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 478.0, 416.0, 54.0, 22.0 ],
					"text" : "Scale"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 534.0, 420.0, 18.0, 34.0 ],
					"size" : 2,
					"value" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 534.0, 568.0, 62.0, 22.0 ],
					"text" : "switch 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 522.0, 727.0, 176.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 572.0, 606.0, 303.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 522.0, 604.0, 31.0, 22.0 ],
					"text" : "int 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 368.0, 514.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 368.0, 480.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 522.0, 657.0, 336.0, 53.0 ]
				}
...
,
					"patching_rect" : [ 573.5, 47.0, 150.0, 126.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 9.0, 16.0, 375.0, 127.0 ],
...
,
					"patching_rect" : [ 573.5, 182.5, 238.0, 149.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
