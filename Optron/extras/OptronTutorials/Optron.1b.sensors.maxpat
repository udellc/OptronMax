...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.0, 223.0, 174.0, 49.0 ],
					"text" : ";\rmax launchbrowser https://youtu.be/v0HdvQAr8fw"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 56.0, 154.5, 122.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, 148.0, 37.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 699.0, 205.0, 33.0 ],
					"text" : "X Axis: Tracks position of hand up and down (strumming motion)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 699.0, 178.0, 33.0 ],
					"text" : "Z Axis: Tracks distance of hand from surface of the instrument"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 673.0, 249.0, 20.0 ],
					"text" : "Stereo Infrared Proximity Sensor: Air Guitar"
				}
...
,
					"patching_rect" : [ 245.0, 738.0, 150.0, 126.0 ],
					"varname" : "patch_5[1]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 11.0, 738.0, 150.0, 126.0 ],
					"varname" : "patch_5",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 398.5, 33.0, 164.0, 87.0 ],
					"text" : "Note: Turn off Effects from previous Techolette before proceeding with this one!\nOr, Unplug Optron and Replug+reconnect in the Mini App."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 898.0, 213.0, 60.0 ],
					"text" : "Click the glitter button in the top left to turn it GREEN. Turning on the glitter effect will cause Optron to report glitter position in the box to the left"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 898.0, 212.0, 60.0 ],
					"text" : "The Optron also reports generative data from effects. Glitter reports the LED position of a glitter spark on the Optron"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 628.0, 505.0, 420.0, 47.0 ],
					"text" : "Fret is calculated from the OptronMiniApp on the other screen.\nYou can divide the Linear sensor into zones like keys on a piano or a guitar fret board."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 447.0, 420.0, 47.0 ],
					"text" : "Linear Sensor\nThe rectangular pad tracks the position of your finger(s)\nIf two or more fingers make contact, sensor will report heightest finger up"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 82.0, 151.0, 33.0 ],
					"text" : "(--input--)\nOptronMini"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 33.0, 150.0, 47.0 ],
					"text" : "To create a new sensor input, click the dropdown menu and select:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 447.0, 212.0, 33.0 ],
					"text" : "Force Sensitive Resistor: FSR\nThe circular pad senses pressure."
				}
...
,
					"patching_rect" : [ 245.0, 963.0, 237.0, 214.0 ],
					"varname" : "patch_4",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 11.0, 963.0, 150.0, 126.0 ],
					"varname" : "patch_3",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 476.0, 505.0, 150.0, 126.0 ],
					"varname" : "patch_2[2]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 245.0, 505.0, 150.0, 126.0 ],
					"varname" : "patch_2[1]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 11.0, 505.0, 150.0, 126.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 245.0, 190.0, 181.0, 60.0 ],
					"text" : "Gyroscopes (Gyros): gX, gY, gZ\nMeasure velocity of rotation on each axis. The magnitude of movement when you rotate."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 11.0, 190.0, 181.0, 47.0 ],
					"text" : "Accelerometers: aX, aY, aZ\nMeasure tilt position relative to the gravitional pull on each axis"
				}
...
,
					"patching_rect" : [ 245.0, 254.0, 150.0, 126.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 11.0, 254.0, 150.0, 126.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
