...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 685.0, 2731.0, 150.0, 33.0 ],
					"text" : "Hint, look at this number to display pitch finger is on"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 897.0, 2733.0, 150.0, 60.0 ],
					"text" : "Make Youtube link to major song and minor song, match key and scale to play along!"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 313.0, 3021.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 313.0, 2987.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
,
					"patching_rect" : [ 313.0, 2832.0, 105.0, 145.0 ],
					"varname" : "patch_2",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 313.0, 2691.0, 150.0, 126.0 ],
					"varname" : "patch_1[7]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 513.0, 2863.0, 29.5, 22.0 ],
					"text" : "i 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 513.0, 3093.0, 75.0, 22.0 ],
					"text" : "s MIDI_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 513.0, 2900.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 513.0, 2932.0, 238.0, 149.0 ],
					"varname" : "patch_1[5]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 523.5, 2691.0, 150.0, 126.0 ],
					"varname" : "patch_1[6]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 479.0, 2278.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 498.0, 2322.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 498.0, 2354.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 2578.0, 75.0, 22.0 ],
					"text" : "s MIDI_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 2385.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 498.0, 2417.0, 238.0, 149.0 ],
					"varname" : "patch_1[4]",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 511.0, 2176.0, 150.0, 126.0 ],
					"varname" : "patch_1",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 542.0, 1758.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 1758.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 498.0, 1796.0, 63.0, 22.0 ],
					"text" : "metro 250"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 1829.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 498.0, 1867.0, 59.0, 22.0 ],
					"text" : "random 7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 2115.0, 75.0, 22.0 ],
					"text" : "s MIDI_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 1908.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 498.0, 1954.0, 238.0, 149.0 ],
					"varname" : "patch_1[3]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 542.0, 1318.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 1318.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 498.0, 1356.0, 63.0, 22.0 ],
					"text" : "metro 250"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 1389.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 498.0, 1427.0, 69.0, 22.0 ],
					"text" : "counter 0 7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 1675.0, 75.0, 22.0 ],
					"text" : "s MIDI_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 1468.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 498.0, 1514.0, 238.0, 149.0 ],
					"varname" : "patch_1[2]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 940.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 498.0, 978.0, 69.0, 22.0 ],
					"text" : "counter 0 7"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 1226.0, 75.0, 22.0 ],
					"text" : "s MIDI_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 1019.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 498.0, 1065.0, 238.0, 149.0 ],
					"varname" : "patch_1[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 738.0, 797.536078999999972, 291.0, 24.0 ],
					"text" : "MIDI Pitch Number displayed"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 738.0, 771.536078999999972, 291.0, 24.0 ],
					"text" : "Corresponding pitch will display on keyboard"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 128.0, 222.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 499.0, 120.0, 53.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 189.0, 189.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 44.0, 334.0, 60.0 ],
					"text" : "You'll learn to use musical scales. Learn the difference between scales versus scale degrees. You'll also learn abbout Tonic note, or key. You'll use numbers and algorithms to make your own melodies and patterns!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.0, 15.0, 164.0, 27.0 ],
					"text" : "Scales Objectives:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 575.0, 860.0, 428.0, 24.0 ],
					"text" : "MIDI pitches can be sent to synthesizers in Max or other music programs!"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 741.0, 718.536078999999972, 291.0, 51.0 ],
					"text" : "Scale Degree translates numbers into the corresponding MIDI Pitch number based on the key (Tonic) and Scale selection at the top"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.0, 604.5, 291.0, 24.0 ],
					"text" : "Select a scale degree from the dropdown menu"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 552.0, 648.0, 291.0, 37.0 ],
					"text" : "Numbers 0 - 7 correspond to scale degrees\nClick-drag the number box up and down to listen"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.0, 385.5, 172.0, 208.0 ],
...
, 			{
				"box" : 				{
					"id" : "obj-13",
					"items" : [ "Do", ",", "Re", ",", "Mi", ",", "Fa", ",", "Sol", ",", "La", ",", "Ti", ",", "'Do" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 612.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 266.5, 215.0, 37.0 ],
					"text" : "click to open Solfege Intro Video\n\"Sound of Music\" 1965"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 499.0, 258.5, 53.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 329.036078999999972, 181.0, 49.0 ],
					"text" : ";\rmax launchbrowser https://youtu.be/drnBMAEA3AM"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 358.0, 73.0, 22.0 ],
					"text" : "r MIDI_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 860.0, 75.0, 22.0 ],
					"text" : "s MIDI_pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 190.25, 341.0, 56.0, 20.0 ],
					"text" : "Duration"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.25, 371.0, 82.0, 16.0 ],
					"size" : 1000.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 102.0, 284.0, 102.0, 20.0 ],
					"text" : "Velocity (0 - 127)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 102.25, 314.0, 82.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 446.0, 40.0, 21.0 ],
					"text" : "Pitch",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 446.0, 57.0, 21.0 ],
					"text" : "Velocity",
					"textcolor" : [ 0.501961, 0.501961, 0.501961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 478.0, 199.0, 23.0 ],
					"text" : "noteout"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 15.0, 446.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 400.0, 193.5, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.0, 446.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 498.0, 653.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 498.0, 699.0, 238.0, 149.0 ],
					"varname" : "patch_0",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 470.0, 275.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 470.0, 136.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "0",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
