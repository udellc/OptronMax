...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 185.0, 35.0, 25.0 ],
					"text" : "== "
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 161.0, 217.0, 77.0, 25.0 ],
					"text" : "o.route /x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 161.0, 185.0, 91.0, 25.0 ],
					"text" : "o.route /left"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 23.0, 185.0, 103.0, 25.0 ],
					"text" : "o.route /left/x"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 76.0, 135.0, 136.0, 25.0 ],
...
, 			{
				...
				"bootpath" : "/Applications/Max6/Search Path/max enabled/CNMAT-Everything-OSX-MachO/CNMAT_MMJ-Depot/tutorials/Music158/lib",
				"patcherrelativepath" : "../../../../../../../../../Applications/Max6/Search Path/max enabled/CNMAT-Everything-OSX-MachO/CNMAT_MMJ-Depot/tutorials/Music158/lib",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
