...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 886.0, 140.0, 58.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 371.0, 503.0, 140.0, 58.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "low-order harmonic ratios", "music 29" ],
					"id" : "obj-77",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
					...
					"patching_rect" : [ 689.0, 810.0, 511.0, 76.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 494.0, 511.0, 76.0 ]
				}

			}
, 			{
				"box" : 				{
					"args" : [ "low-order HR", "0.1a", "Campion / Lubow / Zbyszynski", "low-order HR", 6666 ],
					"id" : "obj-76",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ 2.0, 4.0 ],
					"patching_rect" : [ 363.0, 810.0, 298.0, 89.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 359.0, 405.0, 298.0, 89.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 250.0, 130.0, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 63.209991, 716.0, 41.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 617.0, 97.0, 86.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 463.0, 990.0, 198.0, 53.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 23.0, 462.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 849.0, 7.0, 195.0, 38.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 34.0, 460.0, 218.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 405.0, 252.0, 53.0 ],
					"range" : 36
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 810.0, 38.0, 40.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.209991, 752.0, 100.0, 192.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 661.0, 405.0, 100.0, 165.0 ]
				}
...
, 			{
				...
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/main/trunk/max/patches/MMJ-DEPOT/CNMAT_MMJ-Depot/modules/Synthesis/reso-string~",
...
, 			{
				...
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/main/trunk/max/patches/MMJ-DEPOT/CNMAT_MMJ-Depot/modules/Data_Storage",
