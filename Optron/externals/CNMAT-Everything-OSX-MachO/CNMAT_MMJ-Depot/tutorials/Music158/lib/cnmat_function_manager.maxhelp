...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 487.0, 416.0, 63.0, 18.0 ],
					"text" : "dict myenvs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 519.0, 384.0, 127.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 476.0, 384.0, 32.5, 16.0 ],
					"text" : "edit"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 414.0, 354.0, 38.0, 16.0 ],
					"text" : "import"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.5, 354.0, 37.0, 16.0 ],
					"text" : "export"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 340.0, 69.0, 16.0 ],
					"text" : "store preset1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 340.0, 71.0, 16.0 ],
					"text" : "recall preset1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 519.0, 354.0, 81.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 476.0, 354.0, 32.5, 16.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.636364, 0, 284.936157, 0.363636, 0, 992.0, 0.852273, 0 ],
					"domain" : 992.0,
					"id" : "obj-58",
					"legend" : 0,
					"maxclass" : "function",
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "cnmat_function_manager.maxpat",
