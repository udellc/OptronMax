...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 54.0, 510.0, 135.0, 18.0 ],
					"text" : "/but11 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.0, 400.0, 40.0, 40.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 159.75, 139.5, 32.0, 20.0 ],
									"text" : "+ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 159.75, 112.5, 59.0, 20.0 ],
									"text" : "split 9 16"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 126.75, 85.0, 52.0, 20.0 ],
									"text" : "split 1 8"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 25.0, 287.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 24.75, 143.75, 105.0, 20.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 24.75, 172.75, 121.0, 20.0 ],
									"text" : "i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.75, 114.75, 32.0, 18.0 ],
									"text" : "127"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 25.0, 85.0, 66.75, 20.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 126.75, 25.0, 25.0, 25.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 24.75, 201.75, 105.0, 20.0 ],
									"text" : "sprintf /but%d %d"
								}
...
,
					"patching_rect" : [ 170.0, 445.0, 104.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 240.0, 60.0, 18.0 ],
					"text" : "/but11 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 240.0, 188.0, 40.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.5, 309.0, 135.0, 18.0 ],
					"text" : "57.97826 83 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.0, 255.0, 135.0, 18.0 ],
					"text" : "0 70 1"
				}
...
, 			{
				"box" : 				{
					"args" : [ "OSC-bcf2000.js", "OSC wrapper for the Behringer BCF2000", "0.269 0.549 0.6671.000" ],
					"id" : "obj-2",
					"lockeddragscroll" : 1,
					"maxclass" : "bpatcher",
					"name" : "banner.maxpat",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 39.0, 95.0, 20.0, 140.0 ],
					"setminmax" : [ 0.0, 127.0 ],
					"slidercolor" : [ 0.098172, 0.60633, 0.8, 1.0 ],
					"spacing" : 2,
					"thickness" : 4
				}
...
, 			{
				"box" : 				{
					"args" : [ "OSC-bcf2000.js.help", "1.1a", "Macallum & Hunt", "OSC-bcf2000.js", 2950, "0.269 0.549 0.6671.000" ],
					"id" : "obj-38",
					"maxclass" : "bpatcher",
					"name" : "badge.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 338.0, 400.0, 296.0, 86.0 ],
...
,
					"patching_rect" : [ 555.0, 274.0, 62.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 62.0, 173.0, 258.0, 27.0 ],
...
,
					"patching_rect" : [ 555.0, 295.0, 62.0, 20.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 320.0, 192.0, 21.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 224.0, 68.0, 18.0 ],
					"text" : "dispch $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 240.0, 54.0, 18.0 ],
					"text" : "/but1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 180.0, 188.0, 40.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 240.0, 58.0, 18.0 ],
					"text" : "/rot12 $1"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.259166, 0.694884, 0.866667, 1.0 ],
					"fgcolor" : [ 0.666667, 0.666667, 0.666667, 1.0 ],
					"id" : "obj-25",
					"maxclass" : "dial",
					...
					"outlinecolor" : [ 0.882353, 0.882353, 0.882353, 1.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 105.0, 188.0, 40.0, 40.0 ],
					"vtracking" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 340.0, 124.0, 21.0 ],
					"text" : "/but6 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 240.0, 54.0, 18.0 ],
					"text" : "/fad3 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 215.0, 152.0, 20.0 ],
					"text" : "pack 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 399.0, 192.0, 152.0, 20.0 ],
					"text" : "ctlin BCF2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.0, 287.0, 124.0, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "int" ],
					"patching_rect" : [ 38.0, 309.0, 158.0, 20.0 ],
					"text" : "unpack 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 38.0, 335.0, 158.0, 20.0 ],
					"text" : "ctlout BCF2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 286.0, 107.0, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 445.5, 123.0, 131.0, 62.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 408.5, 325.0, 513.5, 325.0 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "OSC-bcf2000.js",
				"bootpath" : "/Users/jml/Documents/materials/programming/max_files/5_berkeley/projects/cnmat/repositories/main/trunk/max/patches/MMJ-DEPOT/CNMAT_MMJ-Depot/modules/Controllers/OSC-bcf2000",
				"patcherrelativepath" : "",
				"type" : "TEXT",
				"implicit" : 1
			}
