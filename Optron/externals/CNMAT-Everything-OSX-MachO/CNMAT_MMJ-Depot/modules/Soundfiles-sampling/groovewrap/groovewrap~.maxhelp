...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 540.0, 32.5, 18.0 ],
					"text" : "120"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 460.0, 291.0, 44.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 564.5, 291.0, 159.5, 48.0 ],
					"text" : "play <n> number of times, then continue looping or stop, based on loop setting."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 291.0, 53.0, 18.0 ],
					"text" : "/play $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 178.0, 161.0, 20.0 ],
					"text" : "(100 cents = 1 half-step)"
				}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 90.25, 126.5, 74.0, 20.0 ],
													"text" : "prepend set"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "" ],
													"patching_rect" : [ 50.0, 118.0, 33.0, 20.0 ],
													"text" : "t b s"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 50.0, 169.0, 113.5, 20.0 ],
													"text" : "info~ temp"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 120.25, 192.5, 50.0, 18.0 ],
													"text" : "max $1"
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 120.25, 270.5, 25.0, 25.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 52.0, 49.0, 15.0 ],
									"text" : "/loop $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 160.0, 52.0, 64.0, 15.0 ],
									"text" : "/loopend $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 160.0, 30.0, 76.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 75.0, 52.0, 72.0, 15.0 ],
									"text" : "/loopstart $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "float", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 75.0, 30.0, 76.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 99.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 111.0, 12.0, 76.0, 17.0 ],
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 169.5, 83.0, 28.0, 83.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 389.0, 37.0, 18.0 ],
					"text" : "/stop"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.0, 459.0, 46.0, 20.0 ],
					"text" : "s OSC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.0, 418.0, 113.0, 18.0 ],
					"text" : "/gw1/dump bang",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 193.0, 503.0, 73.0, 20.0 ],
					"text" : "s post-state",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 621.0, 178.0, 125.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 545.0, 365.0, 277.0, 48.0 ],
					"text" : "The dump message gathers all parameters of all groovewrap voices and sends them out the right outlet"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 598.0, 448.0, 141.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 249.0, 155.0, 244.0, 20.0 ],
					"text" : "transposition in cents (floating point) +/-"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 533.0, 356.0, 287.0, 161.0 ],
					"rounded" : 20
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 519.5, 420.0, 144.5, 420.0 ],
					"source" : [ "obj-40", 0 ]
				}
