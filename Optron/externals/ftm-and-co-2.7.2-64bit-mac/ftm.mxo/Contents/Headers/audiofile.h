...
FTS_API int fts_audiofile_write(fts_audiofile_t *audiofile, float **buf, int n_buf, long buflen);
FTS_API int fts_audiofile_read(fts_audiofile_t *audiofile, float **buf, int n_buf, long buflen);
FTS_API int fts_audiofile_write_interleaved(fts_audiofile_t *audiofile, float *buf, int n_channels, long buflen);
FTS_API int fts_audiofile_read_interleaved(fts_audiofile_t *audiofile, float *buf, int n_channels, long buflen);

/** set read position to sample frame given in offset */
FTS_API int fts_audiofile_seek(fts_audiofile_t *audiofile, long offset);
