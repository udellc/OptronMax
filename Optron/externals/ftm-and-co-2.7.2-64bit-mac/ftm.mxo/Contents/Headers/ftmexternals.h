...
FTS_API void maxext_class_dsp64(ftmext_class_t *cl, void (*dsp_init64)(ftmext_t *_e, t_object *dsp64, short *count, double samplerate, long maxvectorsize, long flags));
FTS_API void maxext_compatibility_restore(ftmext_t *ext, fts_symbol_t selector, long ac, fts_atom_t *at);
...
#if !defined(C74_MAX_SDK_VERSION) || C74_MAX_SDK_VERSION < 0x0610 // 32bit audio
# define FTMEXT_CLASS_DSP(p) do { maxext_class_dsp(_c, _FTMEXT_GEN_METHOD_NAME(_ ## p, dsp_init)); } while(0)
#else   // 64bit audio
# define FTMEXT_CLASS_DSP(p) do { maxext_class_dsp64(_c, _FTMEXT_GEN_METHOD_NAME(_ ## p, dsp_init64)); } while(0)
#endif
...
FTS_API void maxext_init_finalize(ftmext_t *ext, long ac, fts_atom_t *at);
...
#define FTMEXT_INIT_RETURN \
  } maxext_init_finalize(_e, _nn, _a); \
...
#define _FTMEXT_CONVERT_REFERENCES(e, n, a) do { \
  if((e)->head.ftm_objref_conv != 0) { fts_atom_t *_aa = (fts_atom_t *)alloca(sizeof(fts_atom_t) * (n)); long _i; \
...
#define FTMEXT_METHOD_NUMBER(p, m) static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, double _x); \
  static void _FTMEXT_GEN_METHOD_NAME_TYPE(p, m, number) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
...
#define FTMEXT_METHOD_SYMBOL(p, m) static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, fts_symbol_t _r); \
  static void _FTMEXT_GEN_METHOD_NAME_TYPE(p, m, symbol) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
...
#define FTMEXT_METHOD_BOOLEAN(p, m) static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, int _b); \
  static void _FTMEXT_GEN_METHOD_NAME_TYPE(p, m, boolean) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { int _b = 0; \
...
#define FTMEXT_METHOD_OBJECT(p, t, m) static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, fts_object_t *_o); \
  static void _FTMEXT_GEN_METHOD_NAME_TYPE(p, m, object) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { fts_object_t *_o = NULL; \
...
#define FTMEXT_METHOD_ANY(p, m) static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, fts_atom_t *_a); \
  static void _FTMEXT_GEN_METHOD_NAME_TYPE(p, m, any) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
...
#define FTMEXT_METHOD_VARARGS(p, m) static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, long _n, fts_atom_t *_a); \
  static void _FTMEXT_GEN_METHOD_NAME_TYPE(p, m, varargs) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
    _FTMEXT_CONVERT_REFERENCES(_e, _n, _a); \
    _FTMEXT_GEN_METHOD_NAME(p, m)(_e, _n, _a); } \
  static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, long _n, fts_atom_t *_a) { if(0) goto _ftmext_exit_label; {

#define FTMEXT_METHOD_SELECTED(p, m) static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a); \
  static void _FTMEXT_GEN_METHOD_NAME_TYPE(p, m, selected) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
    _FTMEXT_CONVERT_REFERENCES(_e, _n, _a); \
    _FTMEXT_GEN_METHOD_NAME(p, m)(_e, _s, _n, _a); } \
  static void _FTMEXT_GEN_METHOD_NAME(p, m) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { if(0) goto _ftmext_exit_label; {

#define FTMEXT_METHOD_ANYTHING(p) static void _FTMEXT_GEN_METHOD_NAME(p, anything) (ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
 ...
 *
 */
FTS_API void maxext_class_message(ftmext_class_t *ftmext_class, const char *name, fts_class_t *type, ftmext_method_t ftmext_method, method max_method, const char *doc);
FTS_API void maxext_class_attribute(ftmext_class_t *ftmext_class, const char *name, fts_class_t *type, ftmext_method_t ftmext_method, method max_method, int field, const char *doc);
...
#define FTMEXT_INLET(p) static void p ## _inlet(ftmext_t *_e, long _wi, fts_symbol_t _s, long _n, fts_atom_t *_a); \
/* static void _ ## p ## _inlet_bang(ftmext_t *_e) { p ## _inlet(_e, _MAXEXT_GET_INLET(_e), NULL, 0, NULL); } */ \
  ...
  static void _ ## p ## _inlet_object(ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { long _wi = _MAXEXT_GET_INLET(_e); \
    if(_n > 0) { \
      if(fts_is_object(_a)) { p ## _inlet(_e, _wi, NULL, 1, _a); } \
        ...
        else { ftmext_error(_e, "inlet %ld: invalid FTM object identifier: %s", _wi, fts_symbol_name(fts_get_symbol(_a))); } } \
      else { ftmext_error(_e, "inlet %ld: invalid FTM object reference", _wi); } } \
    else { ftmext_error(_e, "inlet %ld: missing FTM object reference", _wi); } } \
  static void _ ## p ## _inlet_list(ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
    _FTMEXT_CONVERT_REFERENCES(_e, _n, _a); \
    if(_e->cl->inlet_mode != inlet_mode_dispatch_varargs) { p ## _inlet(_e,  _MAXEXT_GET_INLET(_e), NULL, _n, _a); } \
    else { long _wi = _MAXEXT_GET_INLET(_e); long _i; if(_wi + _n > _e->n_inlets_ctl) _n = _e->n_inlets_ctl - _wi; for(_i=_n-1; _i>=0; _i--) p ## _inlet(_e, _wi + _i, NULL, 1, _a + _i); } } \
  static void _ ## p ## _inlet_anything(ftmext_t *_e, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
    _FTMEXT_CONVERT_REFERENCES(_e, _n, _a); \
    p ## _inlet(_e, _MAXEXT_GET_INLET(_e), _s, _n, _a); } \
  static void p ## _inlet(ftmext_t *_e, long _wi, fts_symbol_t _s, long _n, fts_atom_t *_a) { \
...
FTS_API void maxext_dsp_add64(ftmext_t *ext, void *perform64, t_object *dsp64, short *count, double samplerate, long maxvectorsize, long flags);
FTS_API int maxext_dsp_idle(ftmext_t *ext, float **outputs, int n_tick);
FTS_API int maxext_dsp_idle64(ftmext_t *ext, double **outputs, int n_tick);

#ifndef DOXYGEN_DOC

#if !defined(C74_MAX_SDK_VERSION) || C74_MAX_SDK_VERSION < 0x0610

///////////////////////////////////////////////
// create 32bit audio dsp chain for Max 5 and 6
//

/* dsp initialization */
#define FTMEXT_DSP_INIT(p) \
static void _FTMEXT_GEN_METHOD_NAME(_ ## p, dsp_init) (ftmext_t *_e, t_signal **_sp, short *count) \
{ \
  int    _dsp_size = _sp[0]->s_n;	\
  double _dsp_sr   = _sp[0]->s_sr;	\
  void *_pr = (void *)_FTMEXT_GEN_METHOD_NAME(_ ## p, perform); \
  int _i; \
  for (_i = 0; _i < ftmext_get_inlets_dsp(_e); _i++) { ftmext_set_connected(_e, _i, count[_i]); } /* init inlet connected array */ \
  if(0) goto _ftmext_exit_label; \
  {

#define FTMEXT_DSP_INIT_RETURN \
  } \
  maxext_dsp_add(_e, _pr, _sp, ftmext_get_inlets_dsp(_e) + ftmext_get_outlets_dsp(_e)); \
  _ftmext_exit_label: ; \
}

/* dsp performance */
#define FTMEXT_DSP_PERFORM(p)					\
static t_int * _FTMEXT_GEN_METHOD_NAME(_ ## p, perform) (t_int *_dsp_words) \
{ \
  ftmext_t *_e  = (ftmext_t *) (_dsp_words[1]); \
  int _dsp_size = (int)(_dsp_words[2]); \
  if (maxext_dsp_idle(_e, (float **)(_dsp_words + 3 + ftmext_get_inlets_dsp(_e)), _dsp_size)) \
...
/* return pointers to signal buffers */
//TODO: 64bit: return pointer to double t_sample
...
//
// end 32 bit dsp chain
///////////////////////

#else

/////////////////////////////////////////
// create 64bit audio dsp chain for Max 7
//

/* dsp initialization */
#define FTMEXT_DSP_INIT(p) \
static void _FTMEXT_GEN_METHOD_NAME(_ ## p, dsp_init64) (ftmext_t *_e, t_object *dsp64, short *count, double samplerate, long maxvectorsize, long flags) \
{ \
  long   _dsp_size = maxvectorsize;				  \
  double _dsp_sr   = samplerate;			       	  \
  void *_pr = (void *)_FTMEXT_GEN_METHOD_NAME(_ ## p, perform64); \
  int _i; \
  for (_i = 0; _i < ftmext_get_inlets_dsp(_e); _i++) { ftmext_set_connected(_e, _i, count[_i]); } /* init inlet connected array */ \
  if(0) goto _ftmext_exit_label; \
  {
...
#define FTMEXT_DSP_INIT_RETURN \
      ...
      maxext_dsp_add64(_e, _pr, dsp64, count, samplerate, maxvectorsize, flags); \
  _ftmext_exit_label: ; \
}

/* dsp performance */
#define FTMEXT_DSP_PERFORM(p)						\
static void _FTMEXT_GEN_METHOD_NAME(_ ## p, perform64) (ftmext_t *_e, t_object *dsp64, double **ins, long numins, double **outs, long numouts, long sampleframes, long flags, void *userparam) \
{									\
  long _dsp_size = sampleframes;						\
  if (!maxext_dsp_idle64(_e, outs, _dsp_size))			\
  {

#define FTMEXT_DSP_PERFORM_RETURN } _ftmext_exit_label: ; }

/* return pointers to signal buffers */
//TODO: 64bit: return pointer to double t_sample
#define FTMEXT_GET_DSP_INPUT(i) (ins[i])
#define FTMEXT_GET_DSP_OUTPUT(i) (outs[i])

//
// end 64 bit dsp chain
///////////////////////

#endif // C74_MAX_SDK_VERSION < 0x0700

// common macros valid within FTMEXT_DSP_INIT
...
FTS_API void maxext_anything(ftmext_t *self, fts_symbol_t s, long ac, fts_atom_t *at);
...
FTS_API int replace_hashes(char *str, char *buf, int len, int ac, fts_atom_t *at);
