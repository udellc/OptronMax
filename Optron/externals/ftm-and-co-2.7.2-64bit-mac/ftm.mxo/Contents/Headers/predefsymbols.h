...
PREDEF_SYMBOL( fts_s_mixedlayout, "mixedlayout");
PREDEF_SYMBOL( fts_s_mixedjuxtaposed, "mixedjuxtaposed");
PREDEF_SYMBOL( fts_s_mixedsuperposed, "mixedsuperposed");
